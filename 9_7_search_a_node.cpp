...
int main()
{
    ...
    // searching a node
    bool node_4 = search_Node_Iteratively(head, 4);
    bool node_99 = search_Node_Iteratively(head, 99);
    bool rec_4 = search_Node_Recursively(head, 4);
    node_4 = search_Node_Recursively(head, 4);
    node_99 = search_Node_Recursively(head, 99);

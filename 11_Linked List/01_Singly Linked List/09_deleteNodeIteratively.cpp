/*
File: 09_deleteNodeIteratively.cpp

Problem Statement

Given the head of a singly linked list and an integer index i (0-based), write a function to delete the node present at index i iteratively.

If i = 0, delete the head node and return the updated head of the linked list.

If i > 0, delete the node at position i while maintaining the remaining structure of the linked list.

If the index i is invalid (greater than or equal to the length of the list), the linked list should remain unchanged.

The function should properly deallocate the memory of the deleted node.
*/

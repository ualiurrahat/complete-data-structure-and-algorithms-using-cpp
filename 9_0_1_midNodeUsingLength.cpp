...
// find mid nodes of LL using len
// this is not good practice
// try finding mid node without length
// check other code of midPoint in 9_0_0
// returns the first mid node in case of even lenght of the LL

...
// function to remove duplicatd data noder from the LL
// LL: 1 2 2 3 3 4 ... will become LL: 1 2 3 4
// LL: 1 1 1 1 1 1 1 ....will become LL: 1
...
Node *reverseKGroup(Node *head, int k)
{
    ...
    // loop to reverse k group of nodes
    while (count >= k)
    {
        curr = pre->next;
        nex = curr->next;

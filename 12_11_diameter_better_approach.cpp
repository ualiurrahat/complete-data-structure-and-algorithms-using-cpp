// diameter of a tree: max distance between two nodes
// better solution to find diameter.
#include <bits/stdc++.h>
...
// diameter: distance between two node
// we will find out max distance between two nodes.
// this is known as diameter
// T: O(n*height).
...
// function for diameter and height together
// T: O(n)
// better function than the diameter function.

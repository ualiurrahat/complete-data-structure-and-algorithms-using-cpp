...
example: 10 5 15 2 6 -1 -1 -1 -1 -1 -1
sol:The greatest value node of the BST which is smaller than or equal to  7 is 6.
*/
...
int main()
{
    ...
    printTree(root);
    // find floor for the value 4.
    int f = findFloor(root, 7);
    cout << "floor : " << f << endl;
    delete root;
